@extends('main')
@section('titulo', 'Formulario de Alunos')
@section('conteudo')
    ...
    <div class="row">
        ...
        <form action="{{ $action }}" method="post">
            @csrf <!--se o formulario vier do sistema externo ele bloqueia-->
            @if(!empty($data->id))
                @method('PUT')
            @endif

            <input type="hidden" name="id" value="{{ old('id', $data->id ?? '')}}"> <!--old confere os dados do formulario, mas naõ apaga-->
            <div class="col-6">
            ...
            <div class="mt-2">
                ...
                <a href="{{ url('aluno/voltar') }}" class="btn btn-success">Voltar</a>
            </div>
